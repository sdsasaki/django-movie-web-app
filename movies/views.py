...
def create(request):
    if request.method == 'POST':
        data = {
            ...
            'Pictures': [{'url': request.POST.get('url') or 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fc/No_picture_available.png/401px-No_picture_available.png'}],
        ...
        try:
            ...
            messages.warning(request, 'Got an eror when trying to create a new movie: {}'.format(e))
